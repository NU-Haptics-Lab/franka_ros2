...
class FrankaRobot {
 public:
   ...
   */
  explicit FrankaRobot(const std::string& robot_ip, const rclcpp::Logger& logger);
  FrankaRobot(const FrankaRobot&) = delete;
  FrankaRobot& operator=(const FrankaRobot& other) = delete;
  FrankaRobot& operator=(FrankaRobot&& other) = delete;
  FrankaRobot(FrankaRobot&& other) = delete;
